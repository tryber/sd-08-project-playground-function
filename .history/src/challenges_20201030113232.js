...
function encode(codigo) {
  ...
  search_replace(codigo,"a","a");
  search_replace(codigo,"e","e");
  search_replace(codigo,"i","i");
  search_replace(codigo,"o","o");
  search_replace(codigo,"u","u5");
  return codigo;
}

function search_replace(codigo,entrada,saida){
  while (codigo.search(entrada)!== -1 ){
