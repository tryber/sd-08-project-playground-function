...
function triangleCheck(lineA = 0, lineB = 0, lineC = 0) {
  ...
  console.log(line);
  // Checks
  // if (line.a < line.b + line.c && line.a > line.b - line.c) return false;
  // if (line.b < line.a + line.c && line.b > line.a - line.c) return false;
  // if (line.c < line.a + line.b && line.b > line.a - line.b) return false;
  return true;
}
